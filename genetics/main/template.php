<?php
			...
			if ($s_usr > 0) {
					...
					$header_buttons_html .= "<li><a href=\"index.php\"><img src=\"css/icons/door_in.png\" alt=\"\" />Login</a>";
			}
...
<div class="row-fluid">
   	<!-- header -->
	<div id="header">
    		<span class="span8"><a href="mod_index.php"><img src="img/header.jpg" alt="Health Education through Active Learning" class="logo"></a>
			</span>
			<span class="span2">
				$header_buttons_html
			</span>
