...
include ('./toolmenu.php');
	...
	if ($_POST['submit']) {
  		...
  		$db->query("UPDATE diagnoses_chosen SET dc_status = 1, dc_note = '$dc_note', dc_citation = '$dc_citation' WHERE dc_id = $dc_id");
	  	//$db->debug();
...
<div id=step>
<h1>Reject a Diagnosis</h1>
<h3>$dia_txt</h3>		
<form method=post>
  	<h3>Add some evidence or reasoning to why this is a rejected diagnosis.</h3>
