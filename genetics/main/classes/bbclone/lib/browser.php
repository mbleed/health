 ...
 *
 * $Header: /cvs/bbclone/lib/browser.php,v 1.99 2007/02/25 12:00:17 christoph Exp $
 *
...
/*  "oxygen" => array(
  ...
  "swift" => array(
    ...
    "title" => "Swift",
    "rule" => array(
      "AppleWebKit" => "\\1" // FIXME: this is just plain wrong... but every other AppleWebKit-based-browser (safari, shiira) was fetched before
    ),
