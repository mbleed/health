 ...
 *
 * $Header: /cvs/bbclone/lib/robot.php,v 1.187 2007/02/26 10:29:44 christoph Exp $
 *
...
$robot = array(
  ...
  "boardreader" => array(
    ...
    "title" => "BoardReader",
    "rule" => array(
      "BoardReader-Image-Fetcher[ /]+([0-9.]{1,10})" => "\\1"
    )
  ),
  "bobby" => array(
    "icon" => "bobby",
  ...
  "cosmix" => array(
    ...
    "title" => "Cosmix",
    "rule" => array(
      "^(voyager|cfetch|CosmixCrawler|carleson)[/ ]([0-9.]{1,10})" => "\\1",
    )
  ),
  "cosmos" => array(
    "icon" => "robot",
