 ...
 *
 * $Header: /cvs/bbclone/lib/regression.php,v 1.29 2007/02/25 12:00:17 christoph Exp $
 *
...
FDM 1.0*/
  ...
  "Biyubi/x.0 (Sistema Fenix; G11; Familia Toledo; es-mx)" => array(
    "robot" => NULL,
    "browser" => "TODO",
    "os" => "TODO",
  ...
  "Der große BilderSauger 2.00u" => array(
    "robot" => "TODO",
    "browser" => NULL,
    "os" => NULL,
  ...
  "htdig/3.1.6 (unconfigured@htdig.searchengine.maintainer)" => array(
    ...
    "browser" => NULL,
    "os" => NULL,
    "description" => "htdig used by the Académie de Toulouse",
    "type" => "R"
  ),
  ...
  "URL Spider Pro/x.0x (innerprise.net)" => array(
    "robot" => "TODO",
    "browser" => NULL,
    "os" => NULL,
  ...
  "URL_Spider_Pro/x.0+(http://www.innerprise.net/usp-spider.asp)" => array(
    "robot" => "TODO",
    "browser" => NULL,
    "os" => NULL,
    "description" => "Innerprise URL Spider Pro (now ES.NET) web indexing / site searching tool",
  ...
  "Web-Bot V1.03" => array(
    ...
    "browser" => "TODO",
    "os" => "TODO",
    "description" => "Unkown link or server checking from Würzburg University Germany (132.187.10.0x)",
    "type" => "R C"
  ),
  "WebBug/5.0" => array(
    "robot" => "TODO",
...
// FIXME: does not work because of escaping, I think
  ...
  "WebSearchBench WebCrawler V1.0 (Beta)- Prof. Dr.-Ing. Christoph Lindemann- Universität Dortmund- cl@cs.uni-dortmund.de- http://websearchbench.cs.uni-dortmund.de/" => array(
    "robot" => "websearchbench",
    "browser" => NULL,
    "os" => NULL,
    "description" => "Dortmund University WebSearchBench - Open source search software",
  ...
  "WebZIP/x.0 (http://www.spidersoft.com)" => array(
    "robot" => "TODO",
    "browser" => "TODO",
    "os" => "TODO",
