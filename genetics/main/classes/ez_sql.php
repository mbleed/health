<?php
	...
	define("EZSQL_DB_USER", "mbleed");		// <-- PostgreSQL db user
	//define("EZSQL_DB_PASSWORD", "%gocubs");	// <-- PostgreSQL db password
	define("EZSQL_DB_PASSWORD", "flyheart24");	// <-- PostgreSQL db password
	define("EZSQL_DB_NAME", "ged");		// <-- PostgreSQL db pname
	define("EZSQL_DB_HOST", "genetics.cnan9we69npe.us-west-2.rds.amazonaws.com");		// <-- PostgreSQL server host
...
$mail->From = "healtheducation@umich.edu";
$mail->FromName = "HEALth System";
$mail->Subject = 'HEALth database not responding';
$mail->Body = 'Go to https://health.dent.umich.edu/genetics/main/index.php to check.';
...
echo "Mailer Error: " . $mail->ErrorInfo;
				...
				$this->print_error('<h4>Error establishing a database connection!<br />The technical team has been notified.</h4>');
